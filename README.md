...
|--------------|---------|----------------------------------------------|
| 15 – 12      | Opcode  | Operation type (e.g., ADD, SUB, LOAD, STORE) |
| 11 – 9       | SR1     | Source Register 1                            |
| 8 – 6        | SR2     | Source Register 2 / Immediate value          |
| 5 – 3        | DR      | Destination Register                         |
| 2            | Imm     | Immediate flag (1 = use SR2 as immediate)    |
| 1 – 0        | unused  | Reserved                                     |
